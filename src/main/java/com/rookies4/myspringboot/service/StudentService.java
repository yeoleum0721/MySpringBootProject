...
public class StudentService {
    ...
    public StudentDTO.Response getStudentByStudentNumber(String studentNumber) {
        Student student = studentRepository.findByStudentNumber(studentNumber)
                .orElseThrow(() -> new BusinessException(
                        ErrorCode.RESOURCE_NOT_FOUND,"Student","student number: ",studentNumber));
        return StudentDTO.Response.fromEntity(student);
    }
    ...
    public StudentDTO.Response createStudent(StudentDTO.Request request) {
        ...
        if (studentRepository.existsByStudentNumber(request.getStudentNumber())) {
            throw new BusinessException(
                    ErrorCode.STUDENT_NUMBER_DUPLICATE,"Student","student number",request.getStudentNumber());
        }
        ...
        if (request.getDetailRequest() != null &&
            ...
            throw new BusinessException(
                    ErrorCode.EMAIL_DUPLICATE,"Student","email", request.getDetailRequest().getEmail());
        }
        ...
        if (request.getDetailRequest() != null &&
            ...
            throw new BusinessException(
                    ErrorCode.PHONE_NUMBER_DUPLICATE, request.getDetailRequest().getPhoneNumber());
        }
    ...
    public StudentDTO.Response updateStudent(Long id, StudentDTO.Request request) {
        ...
        if (!student.getStudentNumber().equals(request.getStudentNumber()) &&
            ...
            throw new BusinessException(
                    ErrorCode.STUDENT_NUMBER_DUPLICATE,request.getStudentNumber());
        }
